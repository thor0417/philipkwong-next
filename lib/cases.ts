...
export const CASES: Record<string, Case> = {
  ...
  'organigram': {
    ...
    significance: '',
    chips: ['', '', ''],
    writeup: 'Designed extraction facility infrastructure and compliance programs for one of Canada\'s leading publicly traded licensed producers. Responsibilities included facility planning, equipment sourcing, operational workflow design, and health and safety compliance. The engagement supported the expansion of extraction and derivative product manufacturing capabilities within a federally regulated production environment.',
  },
  'valens': {
  ...
  'adastra': {
    ...
    significance: '',
    chips: ['', '', ''],
    writeup: 'Developed regulatory strategy, facility design, and compliance architecture for an extraction-focused licensed producer in British Columbia. The engagement included feasibility analysis, municipal approvals, rezoning support, facility planning, and regulatory pathway development. Work established the operational and compliance foundation required to support large-scale cannabis extraction and manufacturing activities.',
  },
  'ets': {
  ...
  'embark': {
    ...
    significance: '',
    chips: ['', '', ''],
    writeup: 'Led regulatory approvals, municipal compliance, and facility development programs for a cannabis extraction and manufacturing operation serving domestic and international markets. The engagement included rezoning, building and fire code compliance, facility design, and regulatory strategy development. Work established the framework required for compliant production within one of Canada\'s most highly regulated manufacturing sectors.',
  },
};
